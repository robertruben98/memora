  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        const _SectionTitle('Títulos del personaje'),
        const SizedBox(height: 12),
        _DeckTitlesGrid(decks: progress.decks),
        const SizedBox(height: 24),
...
class _DeckTitlesGrid extends StatelessWidget {
  final List<DeckProgress> decks;
  const _DeckTitlesGrid({required this.decks});
